...
export const Timeline: FC = () => {
	...
	useGSAP(
		() => {
			...
			tl.to(q(".ab-tm-head"), { opacity: 1, y: 0, duration: 0.9 }).to(
				q(".ab-tm-item"),
		...
		<section ref={sectionRef} className="bg-[#12110e] py-24 text-white sm:py-32">
			<div className="mx-auto max-w-7xl px-6 sm:px-12">
				<div className="ab-tm-head text-center">
					...
					<h2 className="mt-3 font-serif text-3xl font-bold tracking-tight text-white uppercase sm:text-4xl lg:text-5xl">
							...
							return (
								...
								>
									...
									>
										{isEven ? (
											<div>
												<span className="font-serif text-5xl font-extrabold text-white/30 sm:text-6xl lg:text-7xl">
													{item.year}
												</span>
												<h3 className="mt-2 font-sans text-base font-bold tracking-widest text-accent uppercase sm:text-lg">
													{item.title.value}
												</h3>
									...
									<div className="order-2 hidden justify-center lg:col-span-2 lg:flex">
										<div className="relative flex size-6 items-center justify-center">
											<div className="size-3 rotate-45 border border-accent bg-accent/30 shadow-[0_0_12px_rgba(209,160,84,0.8)]" />
										</div>
									</div>
